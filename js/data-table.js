...
(function (k) {
  ...
  function Xa(a) {
    ...
    if (d || (!t && !e && !f && h == na(a) && h == n.length)) for (v = 0; v < h; v++) (l = sa(a, v)), null !== l && (c[l].sWidth = K(n.eq(v).width()));
      ...
      for (v = 0; v < l.length; v++)
        (r = c[l[v]]), (n[v].style.width = null !== r.sWidthOrig && "" !== r.sWidthOrig ? K(r.sWidthOrig) : ""), r.sWidthOrig && e && k(n[v]).append(k("<div/>").css({ width: r.sWidthOrig, margin: 0, padding: 0, border: 0, height: 1 }));
